...
const ar: Dictionary = {
  ...
  emptyPosts: "لا منشورات بعد. سيظهر المحتوى هنا عندما ينشر المالك أول منشور.",
  noCaption: "بدون وصف",
  close: "إغلاق",
  postAlt: "منشور",
...
const en: Dictionary = {
  ...
  emptyPosts: "No posts yet. Content will appear here when the owner publishes the first post.",
